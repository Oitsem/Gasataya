class AmountToWords {
    convert(value) {
        if (value != undefined) {
            ...
            if (nums.length == 2) {
                let fraction = nums[1].toString();
                let fractionString = ((fraction.length != 2) ? fraction + '0' : fraction) + '/100';
                return whole + 'and ' + fractionString;
            } else {
                return whole;
            }
        } else {
...
module.exports = new AmountToWords();
