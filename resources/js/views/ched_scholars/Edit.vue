    ...
    <div>
        <div class="card">
            <div class="card-header">
                ...
                /
                <a class="text-secondary">Edit CHED Scholar</a>
            </div>
            <div class="card-body">
                <div v-if="ifReady">
                    <form v-on:submit.prevent="updateCHEDScholar()">
                        <fieldset disabled>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label for="name">Contact Number</label>
                                        <input type="text" class="form-control" v-model="legal_guardian_contact_number" autocomplete="off" maxlength="15">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-success btn-sm">
                            ...
                            <strong>Update CHED Scholar</strong>
                        </button>
                    </form>
                </div>
                <div v-else>
    ...
    export default {
        ...
        mounted() {
            let promise = new Promise((resolve, reject) => {
                axios.get('/api/ched-scholars/' + this.$route.params.id).then(res => {
                    this.person_id                          = res.data.ched_scholar.person.id;
                    this.first_name                         = res.data.ched_scholar.person.first_name;
                    this.middle_name                        = res.data.ched_scholar.person.middle_name;
                    this.last_name                          = res.data.ched_scholar.person.last_name;
                    this.extension_name                     = res.data.ched_scholar.person.extension_name;
                    this.address                            = res.data.ched_scholar.person.address;
                    this.birthdate                          = res.data.ched_scholar.person.birthdate;
                    this.place_of_birth                     = res.data.ched_scholar.person.place_of_birth;
                    this.civil_status                       = res.data.ched_scholar.person.civil_status;
                    this.citizenship                        = res.data.ched_scholar.person.citizenship;
                    this.number_of_siblings                 = res.data.ched_scholar.person.number_of_siblings;
                    this.sex                                = res.data.ched_scholar.person.sex;
                    this.email                              = res.data.ched_scholar.person.email;
                    this.mobile_number                      = res.data.ched_scholar.person.mobile_number;
                    this.telephone_number                   = res.data.ched_scholar.person.telephone_number;
                    this.occupation                         = res.data.ched_scholar.person.occupation;
                    this.zip_code                           = res.data.ched_scholar.person.zip_code;
                    this.district                           = res.data.ched_scholar.person.district;

                    this.id                                 = res.data.ched_scholar.id;
                    this.school_last_attended               = res.data.ched_scholar.school_last_attended;
                    this.school_last_attended_address       = res.data.ched_scholar.school_last_attended_address;
                    this.highest_attained_grade             = res.data.ched_scholar.highest_attained_grade;
                    this.school_last_attended_sector        = res.data.ched_scholar.school_last_attended_sector;
                    this.school_intended_to_enroll          = res.data.ched_scholar.school_intended_to_enroll;
                    this.school_intended_to_enroll_address  = res.data.ched_scholar.school_intended_to_enroll_address;
                    this.degree_program                     = res.data.ched_scholar.degree_program;
                    this.school_intended_to_enroll_sector   = res.data.ched_scholar.school_intended_to_enroll_sector;
                    this.fathers_first_name                 = res.data.ched_scholar.fathers_first_name;
                    this.fathers_middle_name                = res.data.ched_scholar.fathers_middle_name
                    this.fathers_last_name                  = res.data.ched_scholar.fathers_last_name
                    this.fathers_extension_name             = res.data.ched_scholar.fathers_extension_name;
                    this.fathers_address                    = res.data.ched_scholar.fathers_address;
                    this.fathers_occupation                 = res.data.ched_scholar.fathers_occupation;
                    this.fathers_contact_number             = res.data.ched_scholar.fathers_contact_number;
                    this.fathers_annual_gross_income        = res.data.ched_scholar.fathers_annual_gross_income;
                    this.fathers_name_of_employer           = res.data.ched_scholar.fathers_name_of_employer;
                    this.fathers_employer_address           = res.data.ched_scholar.fathers_employer_address;

                    this.mothers_first_name                 = res.data.ched_scholar.mothers_first_name;
                    this.mothers_middle_name                = res.data.ched_scholar.mothers_middle_name;
                    this.mothers_last_name                  = res.data.ched_scholar.mothers_last_name;
                    this.mothers_extension_name             = res.data.ched_scholar.mothers_extension_name;
                    this.mothers_address                    = res.data.ched_scholar.mothers_address;
                    this.mothers_occupation                 = res.data.ched_scholar.mothers_occupation;
                    this.mothers_contact_number             = res.data.ched_scholar.mothers_contact_number;
                    this.mothers_annual_gross_income        = res.data.ched_scholar.mothers_annual_gross_income;
                    this.mothers_name_of_employer           = res.data.ched_scholar.mothers_name_of_employer;
                    this.mothers_employer_address           = res.data.ched_scholar.mothers_employer_address;

                    this.legal_guardian_first_name          = res.data.ched_scholar.legal_guardian_first_name;
                    this.legal_guardian_middle_name         = res.data.ched_scholar.legal_guardian_middle_name;
                    this.legal_guardian_last_name           = res.data.ched_scholar.legal_guardian_last_name;
                    this.legal_guardian_extension_name      = res.data.ched_scholar.legal_guardian_extension_name;
                    this.legal_guardian_address             = res.data.ched_scholar.legal_guardian_address;
                    this.legal_guardian_occupation          = res.data.ched_scholar.legal_guardian_occupation;
                    this.legal_guardian_contact_number      = res.data.ched_scholar.legal_guardian_contact_number;
                    this.legal_guardian_annual_gross_income = res.data.ched_scholar.legal_guardian_annual_gross_income;
                    this.legal_guardian_name_of_employer    = res.data.ched_scholar.legal_guardian_name_of_employer;
                    this.legal_guardian_employer_address    = res.data.ched_scholar.legal_guardian_employer_address;
        ...
        methods: {
            ...
            updateCHEDScholar() {
                ...
                axios.patch('/api/ched-scholars/' + this.$route.params.id, this.$data).then(res => {
                    this.$router.push({
                        name: 'ched-scholars.view',
