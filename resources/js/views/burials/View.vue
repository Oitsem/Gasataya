<template>
    <div>
        <div class="card">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" v-model="burial.person.first_name + ' ' + burial.person.middle_name + ' '+ burial.person.last_name">
                            </div>
                        </div>
            ...
            <router-link class="btn btn-primary btn-sm" :to="{ name: 'burials.edit' , params: { id: burial.id }}"><i class="fas fa-edit"></i>&nbsp; Edit Burial</router-link>
